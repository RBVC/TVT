        ...
        teams: [
            {
                ...
                members: [
                    ...
                    { name: "Wanderer", role: "THE HEIR", pos: "Main Dancer (Lee Know)", desc: "組織の次期継承者。誰にも心を開かず、完璧な技術と冷めた瞳で獲物を追い詰める孤独な天才。" },
                    ...
                    { name: "Tartaglia", role: "MERCENARY", pos: "Main Dancer / Center / Rapper (Hyunjin)", desc: "戦場にのみ生を感じる狂気の傭兵。彼が踊り始めたら最後、周囲は血と硝煙に染まる組織最強の矛。" },
            ...
            },
            {
                ...
                model: "THE BOYZ",
                members: [
                    { name: "Neuvillette", role: "CHIEF JUSTICE", pos: "Main Vocal / Leader (Sangyeon)", desc: "警察の象徴であり絶対的正義。私情を一切挟まない厳格な裁きによって、混沌を秩序へと変える最高責任者。" },
                    ...
                    { name: "Tighnari", role: "THE SCIENTIST", pos: "Lead Vocal (Jacob)", desc: "最新の科学捜査を司るトップ。現場の微細な証拠から、組織のネットワークを解析する知性の要。" },
