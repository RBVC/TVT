...
window.allGroups["gen1us"] = {
    ...
    concept: "MASQUERADE",
    layout: 3,
    basePath: "images/group/gen1us/masquerade/",
    banner: "main.jpg",
    description: "Teyvat Entertainment初の男性アイドルグループを作るため企画された「レーベル合同サバイバルオーディション番組『HEAVENTEEN』」の合格者9人によって結成されたスーパーユニット。\nデビュー前から俳優、モデル、小説家、アーティスト、インフルエンサーとして各界の第一線で活躍していた多種多様なプロフェッショナル集団であることが最大の特徴。\nパフォーマンス面では、EXOやSF9、XGをロールモデルとしたクールかつラグジュアリーな楽曲を得意とし、高い歌唱力と9人のシンクロダンスで圧倒的なクオリティを誇る。\nONEUSをロールモデルとし、番組最終選考時のチーム編成をそのまま継承した派生ユニット「DCKZ」「BADIT」が存在しており、現在もコンセプトの異なるパフォーマンスを展開している。",
    members: [
        { name: "Diluc", div: "Mondstadt", pos: "Main Vocal / Sub Dancer", label: "FAVONIUS", img: "diluc.jpg", subUnit: "DCKZ", remarks: "アーティスト（Kaeyaとユニット活動中）" },
        ...
        { name: "Tartaglia", div: "Liyue / Snezhnaya", pos: "Main Dancer / Lead Rapper", label: "QIXING", img: "tartaglia.jpg", subUnit: "DCKZ", remarks: "インフルエンサー" },
